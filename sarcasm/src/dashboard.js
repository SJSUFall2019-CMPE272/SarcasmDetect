...
class YukiReport extends Component {
  ...
  initViz() {
    ...
    const vizUrl = 'https://10ay.online.tableau.com/t/yukisarcasmdetect/views/RDSsample1/SarcasmDetect_1?:showAppBanner=true&:display_count=n&:showVizHome=n&:origin=viz_share_link?:refresh=yes'
